...
// TelegramAppKit
#define COCOAPODS_POD_AVAILABLE_TelegramAppKit
#define COCOAPODS_VERSION_MAJOR_TelegramAppKit 0
#define COCOAPODS_VERSION_MINOR_TelegramAppKit 1
#define COCOAPODS_VERSION_PATCH_TelegramAppKit 0
